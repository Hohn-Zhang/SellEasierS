...
-(void) initCommon
{
    ...
    self.backgroundColor = [[SETool colorWithHexCode:@"#26a2a6"] colorWithAlphaComponent:0.6f];
    ...
    self.frame = CGRectMake((KSCREEN_WIDTH - width - 10.0f)/2.0f, (KSCREEN_HEIGHT - height * 2.0f - 10.0f)/2.0f - 64.0f, width + 10.0f, height * 2 + 10.0f);
}
-(void) initContainer
{
